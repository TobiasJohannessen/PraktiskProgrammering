...
int main() {
    ...
    pp::matrix interpolated_grid = BiLinearInterpolator::create(grid_values, x_points, y_points)
                                    .interpolate_grid(new_x_points, new_y_points);
    ...
    double interp_val = BiLinearInterpolator::create(grid_values, x_points, y_points)
                            .interpolate(x_val, y_val);
